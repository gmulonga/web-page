...
function SparesPage() {
  ...
  const [selectedSpareId, setSelectedSpareId] = useState(null); // Initialize with null
  ...
  const handleRequest = (spareId) => {
    setSelectedSpareId(spareId); // Set the selected spare ID in the state
  ...
  const handleSubmit = (event) => {
    ...
    const formData = {
      ...
      email: email,
      phone: phone,
      spare_id: selectedSpareId // Use the selected spare ID from state
    };
